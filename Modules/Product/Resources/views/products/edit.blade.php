                            ...
                            <div class="col-lg-8">
                                <div class="white_box_50px box_shadow_white mb-20 pt-0 p-15">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 digital_file_upload_div_edit" style="display: {{($product->is_physical == 1)?'none':'block'}};">
                                            <div class="primary_input mb-25">
                                                @php
                                            ...
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label" for="pdf_place">{{__('product.in_app_purchase_code') }}</label>
                                                <input type="text" value="{{ !empty($first_sku) ?  $first_sku->in_app_purchase:'' }}" name="in_app_purchase_code" class="primary_input_field">
                                            </div>
                                        </div>
